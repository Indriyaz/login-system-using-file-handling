    ...
    if re.match(p1, email):
        def passwordenter():
          ...
          if len(password) >= 5 and len(password) <= 16 and re.match(p2,password):
            f = open("C:/Users/R2/Documents/test/testy.txt", "a")
...
def login_validation():
     email = input("Please enter your username / email :")
     password = input("please enter your password:")
     f = open("C:/Users/R2/Documents/test/testy.txt","r")
     a=()
     for i in f:
     ...
     if a == ("login Succeessful"):
         print("login Succeessful")
           ...
           def check():
                print("choose Registration or password reset")
                                 ...
                                 if d.lower() == "n":
                                     ...
                                     def repassword():
                                         ...
                                         if len(password) >= 5 and len(password) <= 16 and re.match(p2, password):
                                             ...
                                             f = open("C:/Users/R2/Documents/test/testy.txt", "w")
                                             f.writelines(e)
                                             f.close()
